                ...
                <div className={"home-about-description"}>
                    ...
                    <div className={"home-social-icon-div"}>
                        <div className={"github-icon"}>
                            <a target={"_blank"} href={"https://github.com/fazliddinxamdamov"} rel="noreferrer"> <img
                                src={github} alt="."/> </a>
                        </div>
                        ...
                        <div className={"github-icon"}>
                            <a href={"https://fazliddinxamdamov102@gmail.com"} target={"_blank"} rel="noreferrer"> <img
                                src={mail} alt="."/>
                            </a>
                        </div>

                        <div className={"github-icon"}>
                            <a target={"_blank"} href={"https://medium.com/@fazliddinxamdamov"} rel="noreferrer"> <img
                                src={medium} alt="."/> </a>
                        </div>

                        <div className={"github-icon"}>
                            <a target={"_blank"} href={"https://dev.to/fazliddinxamdamov"} rel="noreferrer"> <img
                                src={dev} alt="."/> </a>
                        </div>
